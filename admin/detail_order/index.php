				...
				<section role="main" class="content-body">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Data Detail Order</h2>
							...
							<div class="panel-body">
								...
								<?php 
 									 ...
 									 include "../koneksi.php";
 									 $no = 0;
 									 $modal=mysqli_query($koneksi," SELECT * FROM `detail_order` ");
									...
									<td><?php echo $no;?></td>
      								...
      								<td><?php echo  $r['id_masakan']; ?></td>
      								<td><?php echo  $r['keterangan']; ?></td>
      								<td><?php echo $r['status_detail_order']?></td>

      						<td> 
        						<a href="#" class="btn btn-danger" onclick="confirm_modal('proses_delete.php?&id_detail_order=<?php echo  $r['id_detail_order']; ?>');">
