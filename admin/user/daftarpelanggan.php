...
if(isset($_POST['save'])){
	...
	mysqli_query($koneksi,"INSERT INTO pelanggan(nama,username,password) VALUES ('$nama','$username','$password')");
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Registrasi Pelanggan</span></li>
							</ol>
					...
					<section class="panel">
						...
						<div class="form-group">
												<label class="col-md-3 control-label">Registrasi Pelanggan</label>
												<div class="col-md-6">
